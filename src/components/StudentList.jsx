...
const StudentList = () => {
  ...
  // useEffect ini akan berjalan sekali saat komponen pertama kali dimuat
  useEffect(() => {
  ...
  // useMemo digunakan untuk optimasi. Logika filter hanya akan berjalan
  // jika 'students' atau 'searchTerm' berubah.
  ...
  if (loading) {
    return <div className="text-center p-8">Loading data member...</div>;
  }
